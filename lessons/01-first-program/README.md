...
## ▶️ Demonstrations
- `01-HelloFirstProgram.cs`
- `02-PredictRunModify.cs`
...
Running `01-HelloFirstProgram.cs` prints exactly:
...
Running `02-PredictRunModify.cs` prints three numbered lines. If you edit one string literal and rerun, only that line changes.

## 🧩 Learner experiment
1. Run `dotnet lessons/01-first-program/02-PredictRunModify.cs`.
...
## ❓ Review questions
1. What does `dotnet lessons/01-first-program/01-HelloFirstProgram.cs` do?
