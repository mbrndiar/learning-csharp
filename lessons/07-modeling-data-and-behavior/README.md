...
- `lessons/07-modeling-data-and-behavior/ReservationTracker/ReservationTracker.csproj`
...
```bash
dotnet build lessons/07-modeling-data-and-behavior/ReservationTracker/ReservationTracker.csproj
```

Run it:

```bash
dotnet run --project lessons/07-modeling-data-and-behavior/ReservationTracker/ReservationTracker.csproj
```
