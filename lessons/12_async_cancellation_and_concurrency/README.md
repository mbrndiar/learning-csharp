...
```bash
dotnet run --project lessons/12_async_cancellation_and_concurrency/async_work_scheduler/AsyncWorkSchedulerSample.csproj
```
...
```bash
dotnet test --project exercises/12_async_cancellation_and_concurrency/tests/AsyncWorkSchedulerPractice.Tests/AsyncWorkSchedulerPractice.Tests.csproj
```

Starter feedback:

```bash
dotnet test --project exercises/12_async_cancellation_and_concurrency/tests/AsyncWorkSchedulerPractice.Tests/AsyncWorkSchedulerPractice.Tests.csproj -p:CourseImplementation=Starter
```
