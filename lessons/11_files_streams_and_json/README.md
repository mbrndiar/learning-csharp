...
```bash
dotnet run --project lessons/11_files_streams_and_json/recipe_journal/RecipeJournalSample.csproj
```
...
```bash
dotnet test --project exercises/11_files_streams_and_json/tests/RecipeStoragePractice.Tests/RecipeStoragePractice.Tests.csproj
```

Starter feedback command:

```bash
dotnet test --project exercises/11_files_streams_and_json/tests/RecipeStoragePractice.Tests/RecipeStoragePractice.Tests.csproj -p:CourseImplementation=Starter
```
