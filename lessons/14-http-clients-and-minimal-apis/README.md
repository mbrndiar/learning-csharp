...
[Lesson 13](../13-sql-and-sqlite/README.md) (SQL and SQLite) content,
...
```bash
dotnet run --no-launch-profile --project lessons/14-http-clients-and-minimal-apis/MiddlewareBookApiSample/MiddlewareBookApiSample.csproj -- --smoke
```
...
```bash
dotnet run --project lessons/14-http-clients-and-minimal-apis/MiddlewareBookApiSample/MiddlewareBookApiSample.csproj
```
...
```bash
dotnet run --no-launch-profile --project lessons/14-http-clients-and-minimal-apis/ReadingListApiSample/ReadingListApiSample.csproj -- --smoke
```
...
```bash
dotnet run --project lessons/14-http-clients-and-minimal-apis/ReadingListApiSample/ReadingListApiSample.csproj
```
