...
```bash
dotnet run --project course/12-async-cancellation-and-concurrency/Samples/AsyncWorkSchedulerSample/AsyncWorkSchedulerSample.csproj
```
...
```bash
dotnet test --project course/12-async-cancellation-and-concurrency/Practice/Tests/AsyncWorkSchedulerPractice.Tests/AsyncWorkSchedulerPractice.Tests.csproj
```

Starter feedback:

```bash
dotnet test --project course/12-async-cancellation-and-concurrency/Practice/Tests/AsyncWorkSchedulerPractice.Tests/AsyncWorkSchedulerPractice.Tests.csproj -p:CourseImplementation=Starter
```
