...
Restore the whole sample solution:

```bash
dotnet restore course/06-projects-solutions-and-builds/Samples/ProjectWorkbench/ProjectWorkbench.slnx
```

Build it:

```bash
dotnet build course/06-projects-solutions-and-builds/Samples/ProjectWorkbench/ProjectWorkbench.slnx -c Debug
```

Run the app project:

```bash
dotnet run --project course/06-projects-solutions-and-builds/Samples/ProjectWorkbench/ProjectWorkbench.App/ProjectWorkbench.App.csproj --configuration Debug
```
...
```text
dotnet add course/06-projects-solutions-and-builds/Samples/ProjectWorkbench/ProjectWorkbench.App/ProjectWorkbench.App.csproj package <PACKAGE_ID>
```
...
```bash
dotnet build course/06-projects-solutions-and-builds/Practice/Starter/ProjectsSolutionsBuildsPractice.csproj
```

Build the completed reference solution:

```bash
dotnet build course/06-projects-solutions-and-builds/Practice/Solution/ProjectsSolutionsBuildsPractice.csproj
```

Run the shared tests against the starter while you work:

```bash
dotnet test --project course/06-projects-solutions-and-builds/Practice/Tests/ProjectsSolutionsBuildsPractice.Tests.csproj -p:CourseImplementation=Starter
```
