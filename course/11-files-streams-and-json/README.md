...
```bash
dotnet run --project course/11-files-streams-and-json/Samples/RecipeJournalSample/RecipeJournalSample.csproj
```
...
- writes a file under the sample's output folder;
...
```bash
dotnet test --project course/11-files-streams-and-json/Practice/Tests/RecipeStoragePractice.Tests/RecipeStoragePractice.Tests.csproj
```

Starter feedback command:

```bash
dotnet test --project course/11-files-streams-and-json/Practice/Tests/RecipeStoragePractice.Tests/RecipeStoragePractice.Tests.csproj -p:CourseImplementation=Starter
```
