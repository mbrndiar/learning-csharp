...
## Samples
- `Samples/hello-first-program.cs`
- `Samples/predict-run-modify.cs`

## Exact run commands from repository root
```bash
dotnet course/01-first-program/Samples/hello-first-program.cs
dotnet course/01-first-program/Samples/predict-run-modify.cs
dotnet build course/01-first-program/Practice/Starter/FirstProgram.csproj
dotnet test --project course/01-first-program/Practice/Tests/FirstProgram.Tests.csproj
dotnet test --project course/01-first-program/Practice/Tests/FirstProgram.Tests.csproj -p:CourseImplementation=Starter
```

## Expected observable behavior
Running `hello-first-program.cs` prints exactly:
...
Running `predict-run-modify.cs` prints three numbered lines. If you edit one string literal and rerun, only that line changes.

## Learner experiment
1. Run `dotnet course/01-first-program/Samples/predict-run-modify.cs`.
...
- Build your starter project first: `dotnet build course/01-first-program/Practice/Starter/FirstProgram.csproj`
- Then run the shared tests against your work: `dotnet test --project course/01-first-program/Practice/Tests/FirstProgram.Tests.csproj -p:CourseImplementation=Starter`
...
## Review questions
1. What does `dotnet course/01-first-program/Samples/hello-first-program.cs` do?
