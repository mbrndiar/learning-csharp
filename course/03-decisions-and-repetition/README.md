# Unit 03: Decisions and repetition
...
## Samples
- `Samples/decisions.cs`
- `Samples/repetition.cs`

## Exact run commands from repository root
```bash
dotnet course/03-decisions-and-repetition/Samples/decisions.cs
dotnet course/03-decisions-and-repetition/Samples/repetition.cs
dotnet build course/03-decisions-and-repetition/Practice/Starter/DecisionsAndRepetition.csproj
dotnet test --project course/03-decisions-and-repetition/Practice/Tests/DecisionsAndRepetition.Tests.csproj
dotnet test --project course/03-decisions-and-repetition/Practice/Tests/DecisionsAndRepetition.Tests.csproj -p:CourseImplementation=Starter
```

## Expected observable behavior
`decisions.cs` prints a label for each score. `repetition.cs` prints a countdown and then prints one character at a time from `GO`, showing that loops can repeat over changing state or over each item in a sequence.

## Learner experiment
1. Run `dotnet course/03-decisions-and-repetition/Samples/repetition.cs`.
...
- Build the starter: `dotnet build course/03-decisions-and-repetition/Practice/Starter/DecisionsAndRepetition.csproj`
- Test your implementation: `dotnet test --project course/03-decisions-and-repetition/Practice/Tests/DecisionsAndRepetition.Tests.csproj -p:CourseImplementation=Starter`
