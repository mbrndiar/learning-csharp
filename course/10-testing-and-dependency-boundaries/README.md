...
```bash
dotnet build course/10-testing-and-dependency-boundaries/Samples/ReminderBoundaryDemo/ReminderBoundaryDemo.csproj
```

Run the sample tests:

```bash
dotnet test --project course/10-testing-and-dependency-boundaries/Samples/ReminderBoundaryDemo.Tests/ReminderBoundaryDemo.Tests.csproj
```
...
```bash
dotnet build course/10-testing-and-dependency-boundaries/Practice/Starter/TestingDependencyBoundariesPractice.csproj
```

Build the reference solution:

```bash
dotnet build course/10-testing-and-dependency-boundaries/Practice/Solution/TestingDependencyBoundariesPractice.csproj
```

Run the tests against the starter implementation while you work:

```bash
dotnet test --project course/10-testing-and-dependency-boundaries/Practice/Tests/TestingDependencyBoundariesPractice.Tests.csproj -p:CourseImplementation=Starter
```

Run the tests against the finished solution:

```bash
dotnet test --project course/10-testing-and-dependency-boundaries/Practice/Tests/TestingDependencyBoundariesPractice.Tests.csproj
```
